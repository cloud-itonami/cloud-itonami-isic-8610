...
`cloud-itonami-isic-8610` accepts contributions to the OSS blueprint, capability
...
- Keep administering a treatment or authorizing a discharge behind the Clinical Oversight Governor.
